...
import 'package:timezone/data/latest.dart' as cb;
import 'package:timezone/timezone.dart' as cb;
...
class UserCreate {
  ...
  factory UserCreate.fromJson(Map<String, dynamic> user) {
    cb.initializeTimeZones();
    final jakartaTimeZone = cb.getLocation('Asia/Jakarta');
    final jakartaCurrentTime = cb.TZDateTime.now(jakartaTimeZone);
